...
class MovieDetailViewController: UIViewController, SingleMovieViewModelOutput, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private lazy var collectionViewCast: UICollectionView = {
    ...
    private lazy var collectionViewSimilarMovies: UICollectionView = {
        let layout = UICollectionViewFlowLayout()
        layout.scrollDirection = .horizontal
        let collectionView = UICollectionView(frame: .zero, collectionViewLayout: layout)
        collectionView.translatesAutoresizingMaskIntoConstraints = false
    ...
    private lazy var sureLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.textColor = .lightGray
        label.font = .systemFont(ofSize: 14, weight: .black)
    ...
    private lazy var imdbImage: UIImageView = {
    ...
    private lazy var relatedMoviesLabel: UILabel = {
        let label = UILabel()
    ...
    func updateSingleMovie(movie: SingleMovie) {
        ...
        var playTime: String = "\(hour)h \(minutes)min · Movie HD"
